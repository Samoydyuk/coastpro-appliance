...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "We repair all major household appliances including refrigerators, washers, dryers, dishwashers, ovens, ranges, cooktops, microwaves, garbage disposals and freezers, on both gas and electric units from all major brands. We also clean dryer vents and install washers, dryers, dishwashers and garbage disposals.",
    category: "general",
    order: 2
  },
  {
