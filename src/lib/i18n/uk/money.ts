...
export const money: Record<keyof typeof source, string> = {
  ...
  'ihord.tab.summary': 'Зведення',
  'ihord.tab.worklist': 'Чеклист',
  'ihord.list.title': 'Чеклист звірки',
  'ihord.list.subtitle': 'Кожен візит періоду і чого йому бракує',
  'ihord.list.progress': 'звірено {done} з {total}',
  'ihord.list.filterAll': 'Усі',
  'ihord.list.filterUnchecked': 'Ще не звірені',
  'ihord.list.filterFlagged': 'З розбіжностями',
  'ihord.list.filterNothingBought': 'Нічого не куплено',
  'ihord.list.sortNewest': 'Спочатку нові',
  'ihord.list.sortOldest': 'Спочатку старі',
  'ihord.list.empty': 'За цим фільтром нічого немає.',
  'ihord.list.checkedAt': 'Звірено {date}',
  'ihord.list.note': 'Нотатка',
  'ihord.list.notePlaceholder': 'Що знайшов — кількома словами',
  'ihord.list.saving': 'Зберігаю…',
  'ihord.list.saveFailed': 'Не збереглося — спробуй ще раз.',
  'ihord.list.theirs': 'У них',
  'ihord.list.ours': 'У нас',
  'ihord.list.collected': 'Отримано',
  'ihord.list.findings': 'Розбіжності',
  'ihord.list.paperwork': 'Документи',
  'ihord.list.noCard': 'У JobPocket цього візиту немає, тож порівнювати нема з чим.',
  'ihord.list.cardUnavailable': 'Цей візит не вдалося прочитати з JobPocket. Рядок неповний, а не порожній.',
  'ihord.list.totalParts': 'Запчастин до компенсації',
  'ihord.list.totalPartsHint': 'вони платять {theirs}',
  'ihord.list.totalDifference': 'Різниця по запчастинах',
  'ihord.list.totalDifferenceHint': 'по {n} роботах, де ти проставив ціну',
  'ihord.list.totalNothingPriced': 'жодної ціни ще не проставлено',
  'ihord.list.owedToYou': 'диспетчер винен тобі {amount} по запчастинах, у виплаті це {half}',
  'ihord.list.owedByYou': 'ти винен диспетчеру {amount} по запчастинах, у виплаті це {half}',
  'ihord.list.owedEven': 'сторони сходяться',
  'ihord.list.totalToYou': 'До виплати за їхніми цифрами',
  'ihord.list.totalResult': 'До виплати з поправкою',
  'ihord.list.totalResultHint': 'запчастини компенсують повністю, решту ділять навпіл — тож долар запчастин це пʼятдесят центів тобі',
  'ihord.list.claimParts': 'Собівартість до компенсації',
  'ihord.list.claimGap': 'різниця {amount}',
  'ihord.list.claimHint': 'Вони платять {theirs} · у застосунку {ours}',
  'ihord.list.claimed': 'Заявлено',
  'ihord.list.searchPlaceholder': 'Пошук по всіх полях',
  'ihord.list.searchFound': 'показано {shown} з {total}',
  'ihord.list.theirInvoices': 'Їхній інвойс',
  'ihord.list.theirSold': 'виставлено',
  'ihord.list.theirCollected': 'зібрано',
  'ihord.list.theirBalance': 'залишок',
  'ihord.list.theirNoPayments': 'жодного платежу не записано',
  'ihord.list.partsTitle': 'Запчастини',
  'ihord.list.partsNoCard': 'У JobPocket запчастин по цьому візиту немає — рахується як нуль.',
  'ihord.list.partsNone': 'На цьому візиті запчастин не записано.',
  'ihord.list.partNumber': 'Номер',
  'ihord.list.qty': 'К-сть',
  'ihord.list.cost': 'Собівартість',
  'ihord.list.charged': 'Виставлено',
  'ihord.list.noPartNumber': 'без номера',
  'ihord.list.paymentsTitle': 'Оплати',
  'ihord.list.paymentsNone': 'За цей візит нічого не отримано.',
  'ihord.list.deposit': 'завдаток',
  'ihord.list.documentsTitle': 'Документи',
  'ihord.list.documentsNone': 'У JobPocket не виставлено ні естімейта, ні інвойса.',
  'ihord.list.docSent': 'надіслано',
  'ihord.list.docSigned': 'підписано',
  'ihord.list.docPaid': 'оплачено',
  'ihord.list.docVoided': 'анульовано',
  'ihord.list.expensesTitle': 'Видатки',
  'ihord.list.expensesNone': 'На цей візит видатків не записано.',
  'ihord.list.receipt': 'чек є',
  'ihord.list.noReceipt': 'без чека',
  'ihord.list.openInApp': 'Відкрити роботу',
  'ihord.list.hint':
    'Галочка тут — це твій власний запис, що ти прочитав рядок. Це не їхнє «Reconciled», яке означає, що гроші вони визнали. Обидва показані окремо, бо це різні твердження і одне не замінює інше.',
  'ihord.list.cardsUnavailable':
    '{n} візитів не вдалося прочитати з JobPocket, тож у їхніх рядках немає ні запчастин, ні документів. Це не означає, що їх там нема.',

  'ihord.flag.missing_in_jobpocket': 'Немає в JobPocket',
  'ihord.flag.missing_in_ihord': 'Немає в їхніх книгах',
  'ihord.flag.not_settled': 'Не підтверджено',
  'ihord.flag.parts_missing_here': 'Вони платять за запчастини, у нас їх нема',
  'ihord.flag.parts_missing_there': 'Ми купили запчастини, вони не платять',
  'ihord.flag.parts_differ': 'Суми за запчастини різні',
  'ihord.flag.parts_without_cost': 'Запчастина без ціни закупівлі',
  'ihord.flag.no_parts_no_expenses': 'Нічого не куплено',
  'ihord.flag.no_invoice': 'Інвойс не виставлено',
  'ihord.flag.not_collected': 'Гроші ще не зібрані',
  'ihord.flag.total_differs': 'Підсумки різняться',
  'ihord.flag.their_invoice_open': 'Їхній інвойс не закритий',
