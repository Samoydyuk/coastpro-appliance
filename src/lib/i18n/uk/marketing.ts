...
export const marketing: Record<keyof typeof source, string> = {
  ...
  // На таблиці каналів ліди рахуються двічі, у двох різних системах, тож
  // жодна колонка не може позичити слово в іншої. «Звернень» — це заповнена
  // форма на цьому сайті; «Лідів» — те, що дійшло до JobPocket, разом з усіма
  // лідами з маркетплейсів, які сайту й не бачили.
  'marketing.col.enquiries': 'Звернень',
  'marketing.col.jpLeads': 'Лідів',
  'marketing.col.costPerJpLead': 'Ціна ліда',
  'marketing.col.jobs': 'Робіт',
  'marketing.col.return': 'Віддача',
  ...
  'marketing.channels.everySub': 'Трафік і звернення — з цього сайту; витрати й віддача — з JobPocket',
  'marketing.channels.nothing': 'За цей період нічого не записано.',
  // Три речі, які ця таблиця мусить про себе сказати, зведені у два рядки. На
  // сторінці вже є примітка про атрибуцію і примітка про мітки, а шостий абзац
  // застережень не читає ніхто.
  'marketing.channels.sourceNote':
    'Візити, звернення, дзвінки й конверсія — це власне відстеження цього сайту: сесія, ' +
    'заповнена форма, дзвінок на відстежуваний номер. Усе, починаючи з «Витрат» і праворуч, ' +
    'приходить із JobPocket — єдиного місця, де лід з маркетплейсу й звернення з сайту лежать ' +
    'в одній книзі. Клієнт із Thumbtack на сайт не заходив, тому в таких рядках перші чотири ' +
    'колонки порожні, а не нульові: такої нагоди в нього просто не було, а нуль читався б як ' +
    'канал, що не працює.',
  'marketing.channels.unattributedNote':
    'За цей період JobPocket виставив {amount} за роботами, у яких немає жодного каналу, — це ' +
    '{share} усього виставленого. Роботи від диспетчерів, дзвінки на власний номер майстерні й ' +
    'клієнти, у яких номер уже був, приходять без чого-небудь, що можна зарахувати. Тож ця ' +
    'таблиця пояснює, звідки взялася решта, а не весь бізнес.',
  'marketing.channels.unattributedNone':
    'За цей період у JobPocket немає виставлених робіт без каналу.',
  'marketing.channels.spendKindNote':
    'Витрати — не однакові за надійністю. З того, що виставили ці канали, {reported} надіслала ' +
    'сама платформа чи маркетплейс, який і брав гроші, а {typed} внесено руками. Канал, у ' +
    'якого витрат немає взагалі, показує риску, а не нуль: його рахунок ніхто не вносив, і це ' +
    'зовсім не те саме, що він був безкоштовним. І ще: рахунок за рекламу — це одна сума за ' +
    'цілий місяць, тож вона потрапляє в той діапазон, у який припадає перше число того ' +
    'місяця. Читайте цю таблицю по календарних місяцях.',
  'marketing.channels.spendNotMirrored':
    'За цей період витрати ще не дійшли до JobPocket, тому колонки з ціною й віддачею порожні. ' +
    'Те, що внесено на сторінці витрат, передається вночі; якщо завтра тут так само порожньо — ' +
    'перевірте ключ JobPocket у налаштуваннях.',
  'marketing.channels.paybackUnavailable':
    'JobPocket не відповів за цей період, тому витрати, ліди, роботи й віддача порожні — на ' +
    'колонки з власного відстеження сайту це не впливає. Діапазон, довший за рік, запитати ' +
    'не можна; якщо він коротший — перевірте ключ JobPocket у налаштуваннях.',
  ...
  'marketplace.detail': 'Що є всередині звернення',
  'marketplace.detailSub':
    'Скільки Thumbtack насправді надіслав разом зі зверненнями за останні {days} днів',
  'marketplace.col.arrivedWith': 'Що прийшло',
  'marketplace.col.share': 'Частка',
  'marketplace.withPhoto': 'Фото або файл',
  'marketplace.withTime': 'Час, коли клієнту зручно',
  'marketplace.withAddress': 'Вулиця й будинок, а не саме лише місто',
  'marketplace.anonymousLead': 'Ні імені, ні міста',
  'marketplace.detailHint':
    'Маркетплейс може почати надсилати менше, не змінюючи при цьому нічого назовні — той самий ' +
    'вебхук, та сама подія, та сама кількість, — і більше ніде на цій сторінці це не проявиться. ' +
    'Звернення з фото шильдика — це те, до чого можна підготуватися ще до виїзду; звернення без ' +
    'імені й без міста — це майже не знайомство. Саме від адреси залежить, чи можна спланувати ' +
    'виїзд, не передзвонюючи, — і тут її рахують, а не припускають: раніше на цій сторінці було ' +
    'написано, що Thumbtack адреси не надсилає, а в першому ж запиті з живого акаунта вона була. ' +
    'Дивіться на частки, а не на кількість: кількість просто повторює, наскільки завантаженим був ' +
    'квартал.',
  'marketplace.detailPurged':
    'Ще {n} звернень із {total} надійшли за цей період, але їх уже знищено за правилом п’яти ' +
    'робочих днів Thumbtack. Вище вони не враховані, а не пораховані як порожні — видалили їх ми, ' +
    'а не вони надіслали менше.',
  ...
  // Звідки взялася кожна цифра. П’ять значень — це `LeadCostOrigin` з JobPocket,
  // і названі вони за тим, наскільки їм можна вірити, а не за тим, звідки їх
  // записали.
  'marketplace.origin.API': 'Надіслав маркетплейс',
  'marketplace.origin.STATEMENT': 'Взято з їхнього рахунку',
  'marketplace.origin.ALLOCATED': 'Розкладено з місячної суми',
  'marketplace.origin.DEFAULT': 'Звичайна ціна каналу',
  'marketplace.origin.MANUAL': 'Внесено вручну',
  'marketplace.originHint':
    'Те, що надіслав маркетплейс, можна звірити з їхнім рахунком; те, що внесли вручну, — це те, ' +
    'як одна людина прочитала цей рахунок одного дня, а для звернення, яке прийшло ще до вебхука, ' +
    'це взагалі єдиний запис, який колись буде. Тому їх рахують окремо — щоб друге ніколи тихо не ' +
    'зійшло за перше.',

  // Витрати, внесені вручну. Вебхук Thumbtack надсилає тільки те, що буде далі,
  // а вивантажити минуле нема як — тож звернення, яке прийшло до підключення,
  // інакше записати неможливо.
  'marketplace.manual.title': 'Витрати, внесені вручну',
  'marketplace.manual.sub':
    'Звернення, які прийшли ще до вебхука, і ті, які він пропустив, — за датою, коли маркетплейс списав гроші, а не коли це записали',
  'marketplace.manual.day': 'Дата списання',
  'marketplace.manual.what': 'За що',
  'marketplace.manual.whatPlaceholder': 'Сушка не гріє, Palm Coast',
  'marketplace.manual.theirId': 'Їхній номер звернення',
  'marketplace.manual.theirIdHint':
    'Номер звернення не обов’язковий, але його варто вставити, якщо він є в рахунку: тоді повторне ' +
    'внесення того самого звернення виправить попередній запис, а не порахує гроші вдруге.',
  'marketplace.manual.add': 'Записати',
  'marketplace.manual.added': 'Записано {amount}, списано {day}.',
  'marketplace.manual.corrected':
    'Цей номер звернення вже був записаний, тож у старому записі тепер {amount}, списано {day}.',
  'marketplace.manual.undo': 'Скасувати',
  'marketplace.manual.duplicate':
    'На цей день уже записана така сама сума. Два звернення цілком можуть коштувати однаково, тож ' +
    'усе може бути правильно, — але перевірте, чи це не одне й те саме, внесене двічі.',
  'marketplace.manual.badDay': 'Виберіть день, коли маркетплейс списав гроші.',
  'marketplace.manual.badAmount': 'Введіть суму так, як вона стоїть у рахунку, — 25 або 25.50.',
  'marketplace.manual.failed': 'Не вдалося записати.',
  'marketplace.manual.removeFailed': 'Не вдалося прибрати.',
  'marketplace.manual.noServer': 'Консоль не достукалася до власного сервера.',
  'marketplace.manual.none': 'За цей період вручну нічого не вносили.',
  'marketplace.manual.total': 'Разом внесено вручну',
  'marketplace.manual.remove': 'Прибрати',
  'marketplace.manual.removing': 'Прибираємо…',
  'marketplace.manual.removeConfirm': 'Прибрати запис на {amount}, списаний {day}?',
  'marketplace.manual.truncated':
    'За цей період внесли більше, ніж показано тут. У списку — найновіші, і підсумок рахує саме їх.',
  'marketplace.manual.hint':
    'Цих сум немає в таблиці вище — і бути не може. Більшість із них стосується звернень, які до ' +
    'JobPocket так і не дійшли: тут просто немає до чого прикріпити витрату. Тож вище — скільки ' +
    'коштували звернення, які справді надійшли, а тут — скільки внесли вручну за той самий період.',
