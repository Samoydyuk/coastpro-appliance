...
export const money = {
  ...
  // The checklist: every visit in turn, with somewhere to record that it has
  // been looked at.
  'ihord.tab.summary': 'Summary',
  'ihord.tab.worklist': 'Checklist',
  'ihord.list.title': 'Reconciliation checklist',
  'ihord.list.subtitle': 'Every visit in the window, and what each one is missing',
  'ihord.list.progress': '{done} of {total} checked',
  'ihord.list.filterAll': 'All',
  'ihord.list.filterUnchecked': 'Not checked yet',
  'ihord.list.filterFlagged': 'With findings',
  'ihord.list.filterNothingBought': 'Nothing bought',
  'ihord.list.sortNewest': 'Newest first',
  'ihord.list.sortOldest': 'Oldest first',
  'ihord.list.empty': 'Nothing matches this filter.',
  'ihord.list.checkedAt': 'Checked {date}',
  'ihord.list.note': 'Note',
  'ihord.list.notePlaceholder': 'What you found, in a few words',
  'ihord.list.saving': 'Saving…',
  'ihord.list.saveFailed': 'Not saved — try again.',
  'ihord.list.theirs': 'Theirs',
  'ihord.list.ours': 'Ours',
  'ihord.list.collected': 'Collected',
  'ihord.list.findings': 'Findings',
  'ihord.list.paperwork': 'Paperwork',
  'ihord.list.noCard': 'JobPocket has no copy of this visit, so there is nothing to compare.',
  'ihord.list.cardUnavailable': 'This visit could not be read from JobPocket. The row is short, not empty.',
  'ihord.list.totalParts': 'Parts to be reimbursed',
  'ihord.list.totalPartsHint': 'they are paying {theirs}',
  'ihord.list.totalDifference': 'Parts difference',
  'ihord.list.totalDifferenceHint': 'across {n} visits you have priced',
  'ihord.list.totalNothingPriced': 'nothing priced by hand yet',
  'ihord.list.owedToYou': 'they owe you {amount} in parts, {half} in the payout',
  'ihord.list.owedByYou': 'you owe them {amount} in parts, {half} in the payout',
  'ihord.list.owedEven': 'the two sides agree',
  'ihord.list.totalToYou': 'To you, their figures',
  'ihord.list.totalResult': 'To you, corrected',
  'ihord.list.totalResultHint': 'parts are reimbursed in full and the rest is split, so a dollar of parts is fifty cents to you',
  'ihord.list.claimParts': 'Parts cost to claim',
  'ihord.list.claimGap': 'off by {amount}',
  'ihord.list.claimHint': 'They pay {theirs} · the app has {ours}',
  'ihord.list.claimed': 'Claimed',
  'ihord.list.searchPlaceholder': 'Search every field',
  'ihord.list.searchFound': 'showing {shown} of {total}',
  'ihord.list.theirInvoices': 'Their invoice',
  'ihord.list.theirSold': 'sold',
  'ihord.list.theirCollected': 'collected',
  'ihord.list.theirBalance': 'balance',
  'ihord.list.theirNoPayments': 'no payment recorded against it',
  'ihord.list.partsTitle': 'Parts',
  'ihord.list.partsNoCard': 'JobPocket holds no parts for this visit — it counts as zero.',
  'ihord.list.partsNone': 'No parts recorded on this visit.',
  'ihord.list.partNumber': 'Part number',
  'ihord.list.qty': 'Qty',
  'ihord.list.cost': 'Cost',
  'ihord.list.charged': 'Charged',
  'ihord.list.noPartNumber': 'no number',
  'ihord.list.paymentsTitle': 'Payments',
  'ihord.list.paymentsNone': 'Nothing has been taken for this visit.',
  'ihord.list.deposit': 'deposit',
  'ihord.list.documentsTitle': 'Documents',
  'ihord.list.documentsNone': 'No estimate or invoice was raised in JobPocket.',
  'ihord.list.docSent': 'sent',
  'ihord.list.docSigned': 'signed',
  'ihord.list.docPaid': 'paid',
  'ihord.list.docVoided': 'voided',
  'ihord.list.expensesTitle': 'Expenses',
  'ihord.list.expensesNone': 'No expenses booked against this visit.',
  'ihord.list.receipt': 'receipt',
  'ihord.list.noReceipt': 'no receipt',
  'ihord.list.openInApp': 'Open the job',
  'ihord.list.hint':
    'A tick here is your own record that you read the row — it is not their "Reconciled", which is their agreement that the money is settled. Both are shown because they are different claims and neither stands in for the other.',
  'ihord.list.cardsUnavailable':
    '{n} visits could not be read from JobPocket, so their rows carry no parts or paperwork. They are not empty visits.',

  // What the sync service found, in words. The service ships the name only.
  'ihord.flag.missing_in_jobpocket': 'Not in JobPocket',
  'ihord.flag.missing_in_ihord': 'Not in their books',
  'ihord.flag.not_settled': 'Not reconciled',
  'ihord.flag.parts_missing_here': 'They pay parts, we recorded none',
  'ihord.flag.parts_missing_there': 'We bought parts, they pay none',
  'ihord.flag.parts_differ': 'Parts figures differ',
  'ihord.flag.parts_without_cost': 'Part with no purchase price',
  'ihord.flag.no_parts_no_expenses': 'Nothing bought',
  'ihord.flag.no_invoice': 'No invoice raised',
  'ihord.flag.not_collected': 'Money still out',
  'ihord.flag.total_differs': 'Totals differ',
  'ihord.flag.their_invoice_open': 'Their invoice still open',
